...
public:
    ...
    //-----------------------------Навигация-----------------------------
    virtual /*int*/void Reset(void) = 0;   // Установить на первую запись
    virtual /*int*/bool IsTableEnded(void) const = 0;
    virtual /*int*/void GoNext(void) = 0; // Переход к следующей записи, (=1 после применения для последней записи таблицы)
};
