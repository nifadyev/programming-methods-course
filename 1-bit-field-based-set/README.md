...
## Инструкция по выполнению работы
  ...
  1. Освоение общих принципов работы с Git и Bitbucket. Последовательность
     ...
     - Создание новой ветки, внесение некоторых изменений (например в файл
       `README.md`)
     - Публикация изменений в виде pull request на Bitbucket
     - Вливание изменений в ветку `master` через веб-интерфейс Bitbucket
